...
import { ListCompanies, UpdateCompany } from '../../../bindings/github.com/fossinvoice/fossinvoice/internal/services/databaseservice.js'
  ...
  return (
    <div className="grid gap-3">
      <div className="flex items-center justify-between">
        ...
        <button className="btn btn-secondary" onClick={() => setShowModal(true)} disabled={!company}>Edit</button>
      </div>
